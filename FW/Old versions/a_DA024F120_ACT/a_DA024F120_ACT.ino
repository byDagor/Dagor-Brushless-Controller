...
//########################################################
// Dagor Controller Alpha 2.4 Firmware Version 1.2.0 for the DAGR Actuator
//########################################################

// The firmware is separated into 6 tabs (a - f), make sure all files are stored in the folder 
// named a_DA024F120_ACT.
...
const float voltageRamp = 30;       //Change in voltage allowed [Volts per sec]       - VR
...
const float alignStrength = 0.9;    // Percentage of power used to calibrate the sensor on start-up
